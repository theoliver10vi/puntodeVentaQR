...
#include "ui_buscararticulos.h"
#include "gestioninventario.h"

BuscarArticulos::BuscarArticulos(QWidget *parent) :
  QMainWindow(parent),
  ui(new Ui::BuscarArticulos)
{
  ui->setupUi(this);
...
BuscarArticulos::~BuscarArticulos()
{
  delete ui;
}

void BuscarArticulos::on_btnRegresar_clicked()
{
  gestionInventario *ventanaGestion = new gestionInventario();
  ventanaGestion->show();
  this->close();
}
